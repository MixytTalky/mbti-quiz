...
(function () {
  ...
  // ── 工具識別（每個工具需修改此值）──
  var TOOL_SLUG = 'tool-mbti-quiz-v1.0.0';    // 版本追蹤用
  var PROJECT_SLUG = 'mbti-quiz';              // UTM utm_source 用（= 專案資料夾名稱）
  ...
  var ADS = [
    {
      ...
      url: 'https://www.gametower.com.tw/Games/FreePlay/Mj/star31'
    },
    {
      title: '滿貫大亨',
      desc: 'gametower',
      ...
      url: 'https://www.gametower.com.tw/Games/TMD/'
    },
    {
      title: '競技麻將2',
      desc: 'cmj2',
  ...
  // ── UTM 參數產生 ──
  // 格式：?utm_source=[slug]&utm_medium=display&utm_campaign=mega_traffic_2026&utm_content=Nth_banner
